...
train_config_file='/home/ma-user/work/algorithm/gr_game_jw_20260630/20260630/train_local.config'
data_path_prefix='game_data_v3/'
period='20260704-000000'
step='train'
version='mtgr_v1_full_sid_jw'
sid_path="/home/ma-user/work/dataset/mini_game_dataset/sid/20260623/appid2sids.txt"
data_dir="/home/ma-user/work/dataset/mini_game_dataset/"
...
NGPUS_PER_NODE="${MA_NUM_GPUS:-2}"   # 本地通常设为1或实际NPU数量
